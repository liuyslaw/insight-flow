...
Cover the full journey, including the period between offer acceptance and the first day — this
window is one of the most fragile points for new hire engagement and is often overlooked.

Return ONLY valid JSON, no markdown fences, no preamble, in this exact shape:
{
  "checklist": {
    "preboarding": ["<task, offer-accepted to Day 1>", ...],
    "day1": ["<task>", ...],
    "week1": ["<task>", ...],
    "month1": ["<task>", ...]
  },
