...
const STORAGE_KEY = 'insightflow_docs_v6'

const sampleOnboardingTemplates = [
  {
    title: 'Standard Onboarding Checklist — Template',
    body: `PRE-BOARDING (offer accepted to Day 1): Send welcome pack and start-date confirmation, collect signed contract and personal particulars, initiate background/reference checks, order equipment and provision accounts ahead of start date, share first-day logistics (time, location, dress code, who to ask for), assign onboarding buddy.
DAY 1: Welcome email sent, workstation and system access confirmed, org chart and team introductions, review job description and reporting line, complete tax and bank details, IT security and acceptable use briefing.
